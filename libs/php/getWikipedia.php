...
if ($iso_code === 'GB') {
    ...
    $gb_url = "http://api.geonames.org/wikipediaSearchJSON?q=Great%20Britain&maxRows=1&lang=en&username=$username";
    ...
    $url = "http://api.geonames.org/wikipediaBoundingBoxJSON?south={$latitude}&north={$latitude}&east={$longitude}&west={$longitude}&maxRows=1&lang=en&username=$username&feature=country&country={$iso_code}";
